...
get_data <- function(type){
    ...
    l$order = order(abs(l$pca$li[,1]),decreasing = T)
    l$order_axis1 = l$pca$li[l$order,]
    l$go_names = l$data[l$order,2]
    return(l)
}
...
text(bp$order_axis1[1,1],bp$order_axis1[1,2], label = bp$go_names[1], pos = 4)
text(bp$order_axis1[2,1],bp$order_axis1[2,2], label = bp$go_names[2], pos = 3)
text(bp$order_axis1[3,1],bp$order_axis1[3,2], label = bp$go_names[3], pos = 3)
text(bp$order_axis1[4,1],bp$order_axis1[4,2], label = bp$go_names[4], pos = 2)
text(bp$order_axis1[5,1],bp$order_axis1[5,2], label = bp$go_names[5], pos = 3)
dev.off()
...
text(mf$order_axis1[1,1],mf$order_axis1[1,2], label = mf$go_names[1], pos = 4)
text(mf$order_axis1[2,1],mf$order_axis1[2,2], label = mf$go_names[2], pos = 1)
text(mf$order_axis1[3,1],mf$order_axis1[3,2], label = mf$go_names[3], pos = 3)
text(mf$order_axis1[4,1],mf$order_axis1[4,2], label = mf$go_names[4], pos = 2)
text(mf$order_axis1[5,1],mf$order_axis1[5,2], label = mf$go_names[5], pos = 3)
dev.off()