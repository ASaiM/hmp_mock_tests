...
SRR072232_gene_families = read.table('previous_results/SRR072232/asaim_results/53_group_on_data_45.tabular', 
    sep = '\t', row.names = 1)
...
SRR072233_gene_families = read.table('previous_results/SRR072233/asaim_results/53_group_on_data_45.tabular', 
    sep = '\t', row.names = 1)
...
SRR072232_pathways = read.table('previous_results/SRR072232/asaim_results/54_group_on_data_47.tabular', 
    sep = '\t', row.names = 1)
...
SRR072233_pathways = read.table('previous_results/SRR072233/asaim_results/54_group_on_data_47.tabular', 
    sep = '\t', row.names = 1)
...
#concatenated_gene_families = read.table('previous_results/concatenated_samples/gene_families/41_compute_on_data_40.tabular',
#    sep = '\t', row.names = 1)
...
#concatenated_pathways = read.table('previous_results/concatenated_samples/pathways/41_compute_on_data_40.tabular',
#    sep = '\t', row.names = 1)
