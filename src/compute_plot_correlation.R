...
expected_species_protein_nb_median = read.table("data/expected_species_protein_nb_median.txt", 
    sep = "\t", row.names = 1)
...
plot_nb(SRR072232_gene_families, 'results/SRR072232/asaim_results/plot_prot_nb_gene_family_number.pdf')
plot_diff_nb(SRR072232_gene_families, 'results/SRR072232/asaim_results/plot_diff_prot_nb_gene_family_number.pdf')
...
plot_nb(SRR072233_gene_families, 'results/SRR072233/asaim_results/plot_prot_nb_gene_family_number.pdf')
plot_diff_nb(SRR072233_gene_families, 'results/SRR072233/asaim_results/plot_diff_prot_nb_gene_family_number.pdf')
...
concatenated_gene_families = read.table('results/concatenated_samples/gene_families/41_compute_on_data_40.tabular',
    sep = '\t', row.names = 1)
print(concatenated_gene_families)
